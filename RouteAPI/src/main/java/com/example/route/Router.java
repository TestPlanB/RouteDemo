...
public class Router {
    ...
    //自动生成的类所在的包名
    public final static   String packageName="com.test.output";

    public static void init(Application application){
        //获取到com.test.output所有的类
        ...
        try {
            ...
            for (String className : classNames) {
                ...
                //判断是否有实现定义的接口
                if (IRouterLoad.class.isAssignableFrom(aClass)){
                    IRouterLoad load= (IRouterLoad) aClass.newInstance();
                    Log.i("hello",aClass.getName());
                    load.loadInfo();
